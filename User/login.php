        ...
        <div class="main-content">
           <h1>Computer Service Management System</h1>
            <div class="form-container">
                <form action="lib/loginUser.php" class="addServiceFrom login-form">
                    <h2>Login User</h2>
                    ...
                    <p>Don't have an account ? <a href="register.php">Create New Account</a><br><a href="../index.php">Back Home</a></p>
                </form>
            </div>
