    <?php
        ...
        $sql="select * from pages where p_name='about'";
...
<body>
    ...
    <div class="content">
        ...
        <section class="service">
            <div class="service-title">
                <h2 >About Us</h2>
                <p name="services" class="service-label">There are following Information of about section available here.</p>
            </div>  
        </section>
    </div>
    <div class="content-about">
        ...
        <section class="main-content">
            ...
            <p style="width: 400px;text-align: center;"><?=$res['p_description']?></p>
        </section>
    </div>
    <div class="footer">
        <?php
